			...
			try {
				...
				if (!cancelled) {
					...
					if (shouldShowDicePopup) {
						const previousLocalPlayer = findLocalStatePlayer(latestStateRef.current.players, sessionUserId, sessionUsername);
						const nextLocalPlayer = findMatchingServerPlayer(serverPlayers, previousLocalPlayer, sessionUserId, sessionUsername);
						setDiceWonResources(
